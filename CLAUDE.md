...
## 2. Problem Statement (đã chốt, không đổi)
...
## 4. Quyết định đã chốt: CẮT route layer khỏi bản demo ngày 10/7

- 0/15 câu Eval liên quan route/hành trình lái xe.
- 30 quán rải 7 tỉnh thành, không đủ mật độ dọc 1 tuyến đường để demo detour có ý nghĩa.
- Route layer chỉ xuất hiện trong slide dưới dạng "hướng mở rộng, kiến trúc sẵn sàng nối Route API có sẵn (Valhalla)", không code trong ngày 10/7. Tối đa 1-2 câu trình bày.
...
Spec kỹ thuật 4 module đã viết trong `/specs/` (01-semantic-search, 02-ocr-parser, 03-review-summary, 04-poi-quality-score). Code viết SAU khi team review spec. Quy ước chung nằm ở mục 0 của spec 01.
