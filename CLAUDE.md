...
- Nhưng: bỏ hẳn route thì mất luôn câu chuyện differentiation duy nhất gắn với VETC (công ty thu phí
  ...
  (~3.5-4h) dùng 1 corridor thật (Hà Nội → Hạ Long) + vài điểm dừng mock, tái dùng 100% engine Module 1,
  dữ liệu mock cách ly hoàn toàn khỏi 30 quán benchmark. Xem `specs/05-route-corridor-demo-spec.md`.
- Module 5 là **stretch feature, ưu tiên thấp nhất, cắt đầu tiên nếu bí giờ** — không ảnh hưởng 4 module core.
